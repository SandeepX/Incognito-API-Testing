...
<head>
    ...
    <title>Forgot Password - Incognito Testing</title>
...
<body class="bg-surface-900 text-surface-100 min-h-screen flex items-center justify-center p-4 selection:bg-blue-500/30">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-surface-400">Forgot your password? No problem.</p>
        </div>

        <!-- Card -->
        <div class="auth-card rounded-2xl p-8">
            @if (session('status'))
                <div class="mb-6 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
