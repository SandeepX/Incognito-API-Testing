...
<head>
    ...
    <title>Sign In - Incognito Testing</title>
...
<body class="bg-surface-900 text-surface-100 min-h-screen flex items-center justify-center p-4 selection:bg-blue-500/30">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-surface-400">Sign in to your account to continue</p>
        </div>
        ...
        <div class="auth-card rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                           class="auth-input w-full rounded-lg px-4 py-2.5 text-sm" placeholder="you@example.com">
                </div>
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <input type="checkbox" name="remember" class="w-3.5 h-3.5 rounded border-surface-600 bg-surface-700 text-blue-500 focus:ring-blue-500/30 accent-blue-500">
                        <span class="text-xs text-surface-400 group-hover:text-surface-300 transition">Remember me</span>
                    </label>
                    <a href="{{ route('password.request') }}" class="text-xs text-blue-400 hover:text-blue-300 font-medium transition">Forgot password?</a>
                </div>
            ...
            <div class="mt-6 pt-5 border-t border-surface-700/50 text-center">
                <p class="text-xs text-surface-400">
                    ...
                    <a href="{{ route('register') }}" class="text-blue-400 hover:text-blue-300 font-medium transition">Create one</a>
                </p>
            </div>
        </div>
