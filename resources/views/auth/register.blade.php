...
<head>
    ...
    <title>Create Account - Incognito Testing</title>
...
<body class="bg-surface-900 text-surface-100 min-h-screen flex items-center justify-center p-4 selection:bg-blue-500/30">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-surface-400">Create your account to get started</p>
        </div>
        ...
        <div class="auth-card rounded-2xl p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label for="name" class="block text-xs font-medium text-surface-300 mb-1.5">Full name</label>
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                           class="auth-input w-full rounded-lg px-4 py-2.5 text-sm" placeholder="John Doe">
                </div>
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-medium text-surface-300 mb-1.5">Confirm password</label>
